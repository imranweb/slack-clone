...
class UserRooms extends React.PureComponent {  
  ...
  render() {
    ...
    const inviteToRooms = <InviteToRoom currentUser={this.props.currentUser} rooms={this.props.rooms} users={this.props.users} 
    onUsersAddedToRoom={this.onUsersAddedToRoom.bind(this)} />
    return <Rooms rooms={this.props.rooms} addRoom={addRoom} currentRoomId={this.props.currentRoomId} heading="Rooms" inviteToRooms={inviteToRooms} />
  }
}
